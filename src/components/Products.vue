    ...
    export default {
        ...
        methods: {
          ...
          searchProducts(page){
            ...
            this.$http.get("products?paginate=true&perPage=3&page=" + page)
            .then(res => {
              var data = res.data;
        ...
        computed: {
          itemsCount () {
            var n1 = this.pagination.currentPage == 1 ? 1 : (this.pagination.currentPage - 1) * this.pagination.itemsPerPage + 1;
            var n2 = this.pagination.currentPage == this.pagination.totalPages ? this.pagination.totalCount : this.pagination.currentPage * this.pagination.itemsPerPage;
