    ...
    computed: {
        ...
        headers: function() {
            ...
            if(this.tableHeaders) {
                ...
                headers = tableDefaults.makeHeadersFromFirstItem(this.data[0], this.excludedHeaders)   
            }
    ...
    methods: {
        setHeaderWidth: function(header) {
            ...
            if(this.columnWidth == 'fit') {
                ...
                header.width = columnWidths[header.value] > headerTextWidth ? columnWidths[header.value] + 50 : headerTextWidth + 50
            } else {
